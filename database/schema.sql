...
CREATE TABLE IF NOT EXISTS characters (
    ...
    seza_super_attack TEXT,
    ultra_super_attack TEXT,
    eza_ultra_super_attack TEXT,
    seza_ultra_super_attack TEXT,
    passive TEXT,
    eza_passive TEXT,
    seza_passive TEXT,
    active_skill TEXT,
    ...
    ki_18_multiplier TEXT,
    ki_24_multiplier TEXT,
