...
export declare const CATEGORY_URLS: readonly ["N", "R", "SR", "SSR", "UR", "UR?from=Evil+Pride+Frieza+(Final+Form)+(Angel)", "UR?from=Next-Level+Strike+Super+Saiyan+God+SS+Goku", "UR?from=Training+and+Refreshment+Goku", "LR"];
