...
function cleanPassiveText(text) {
...
export class TransformationExtractor {
     ...
     */
    static async extractTransformations(source) {
        try {
     ...
     */
    static async findTransformationSections(source) {
     ...
     */
    static async extractSingleTransformation(source, index) {
        try {
     ...
     * Extract transformation name
     */
    static async extractTransformationName(source, index) {
        const nameSelectors = [
     ...
     */
    static async extractTransformationCondition(source, _index) {
     ...
     */
    static parseTransformationCondition(rawCondition) {
     ...
     */
    static async extractTransformationPassive(source, index) {
     ...
     */
    static async extractTransformationSuperAttack(source, index) {
        const saSelectors = [
     ...
     */
    static async extractTransformationKiMultiplier(source, index) {
        const kiSelectors = [
     ...
     */
    static async extractTransformationLinks(source, index) {
        const linkSelectors = [
     ...
     */
    static async extractTransformationCategories(source, index) {
     ...
     */
    static async detectTransformationType(source) {
        const typeDetectors = [
...
//# sourceMappingURL=transformation-extractor.js.map