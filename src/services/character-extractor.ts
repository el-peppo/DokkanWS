...
import { cleanPassiveText, extractCharacterName, extractCharacterTitle, safeParseInt, safeExtractText } from '../utils/text-cleaner.js';
...
export class CharacterExtractor {
    ...
    private static extractEZASuperAttack(document: Document): string | undefined {
        ...
        const skillImage = DOMParser.findByImageName(document, 'Super atk.png');
