    ...
    private async insertCharacter(character: Character): Promise<void> {
        const sql = `
            INSERT INTO characters (
                ...
                standby_skill, standby_skill_condition, transformation_condition, ki_multiplier, ki_12_multiplier, ki_18_multiplier, ki_24_multiplier,
        ...
        const values = [
            ...
            character.standbySkill || null,
            character.standbySkillCondition || null,
